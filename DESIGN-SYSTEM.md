...
| `--sidebar*` | bg = `primary-active` (`#14166d`) · hover = `status-info-fg` (`#282aab`) · **active `#4a4fcf`** · border `#20248f` · badge `#cc3f00` · fg `#fafafa` · ring `#fafafa` | same | rest < hover < active; theme-stable |
