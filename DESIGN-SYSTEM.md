...
| `--sidebar*` | bg `#0f1245` · hover (`--sidebar-accent`) `#14166d` · **selected (`--sidebar-active`) `#1d2080`** · border `#20248f` · badge (`--sidebar-primary`) `#cc3f00` · fg `#fafafa` · ring `#fafafa` | same | dark-navy nav; bg < hover < selected; own values (not aliased to shared brand primitives); theme-stable |
