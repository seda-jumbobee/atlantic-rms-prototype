...
- Brand (since 2026-07-22): **indigo primary `#282aab`** (hover `#20248f`, active `#14166d`) + **orange secondary `#ff4c00`**; sidebar = indigo surface, active item `bg-sidebar-active` (`#14166d`). Figma primitives live in the "Brand Primitives" collection (`brand/primary/*`, `brand/secondary/*`, `feedback/*`, `neutral/*`); old greens are `deprecated/*`.
