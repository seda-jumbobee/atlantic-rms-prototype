...
export const QUOTE_TEMPLATES: QuoteTemplate[] = [
  {
    id: "tpl-la-shanghai", name: "LA → Shanghai · 40HC tractor",
  ...
  {
    id: "tpl-hou-alex-forklift", name: "Houston → Alexandria · forklift",
  ...
  {
    id: "tpl-bal-brv-roro", name: "Baltimore → Bremerhaven · RoRo combine",
  ...
  {
    id: "tpl-sav-mel-fr", name: "Savannah → Melbourne · 40FR combine",
  ...
  {
    id: "tpl-mia-genoa-yacht", name: "Miami → Genoa · yacht RoRo",
