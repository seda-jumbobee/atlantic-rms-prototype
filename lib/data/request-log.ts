...
export const RMS_REQUESTS: RmsRequest[] = [
  ...
  { id: "req-1030", at: "2026-06-23T10:42:15Z", channel: "manager_ui", endpoint: "POST /api/v1/quotes:search", method: "POST", lane: "Charleston IL → Shanghai", commodity: "JD 612C Corn Heads", status: 200, latencyMs: 298, resultTotal: 14600, caller: "nick@atlanticprojectcargo.com" },
